...
public class ShelterService extends AbstractService<Shelter> {
    ...
    // @Produces(MediaType.APPLICATION_JSON)
    // @APIResponses({
    //         @APIResponse(responseCode = "400", description = "Adding JWT failed"),
    //         @APIResponse(responseCode = "200", description = "Adding JWT was successful") })
    // public Response addJWT(Shelter entry) {
    //     MongoCollection<Shelter> shelters = db.getCollection("Shelters",
    //             Shelter.class);
